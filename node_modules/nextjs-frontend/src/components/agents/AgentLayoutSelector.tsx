...
export type AgentLayoutVariant = "grid" | "split" | "luxury" | "matrix" | "studio";
...
export const LAYOUT_OPTIONS: {
...
}[] = [
  {
    ...
    description: "Balanced 3-column cards with gold accents & quick actions",
    icon: LayoutGridIcon,
  },
  {
    id: "split",
    name: "Interactive Split",
    badge: "Search & Map Focus",
    description: "Sticky filter sidebar with agent directory & area statistics",
    icon: ColumnsIcon,
  },
  {
    id: "luxury",
    name: "Executive Luxury",
    badge: "Dark Gold Portfolio",
    description: "High-contrast dark theme with spotlight carousel & sales volume",
    icon: AwardIcon,
  },
  {
    id: "matrix",
    name: "Compact Matrix",
    badge: "Side-by-Side Table",
    description: "Data-dense table with sorting by rating, sales & experience",
    icon: TableIcon,
  },
  {
    id: "studio",
    ...
    description: "Headshot-focused layout with whitespace & sleek badges",
    icon: SparklesIcon,
  },
];
...
export default function AgentLayoutSelector({
  ...
  return (
    <div className="w-full bg-[#07162C] text-white border-b border-[#C9A227]/30 py-3 px-4 sm:px-6 lg:px-8 shadow-lg">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-slate-300 font-body">
              Click any style to preview instantly. Integrate your chosen design as default.
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-wrap items-center justify-center gap-2">
          {LAYOUT_OPTIONS.map((layout) => {
            ...
            return (
              <button
                ...
                className={`group relative flex items-center gap-2 px-3 py-2 rounded-xl text-xs font-heading font-bold transition-all duration-200 cursor-pointer ${
                  isActive
          ...
          {onSetDefault && (
            <button
              ...
              className={`ml-2 flex items-center gap-1.5 px-3.5 py-2 rounded-xl text-xs font-heading font-extrabold transition-all duration-200 cursor-pointer ${
                isSavedAsDefault
