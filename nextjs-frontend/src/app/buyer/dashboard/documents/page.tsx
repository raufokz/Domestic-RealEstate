...
const FALLBACK_DATA: Document[] = [
  { id: 1, name: "Pre-Approval Letter", type: "Financial", date: "Jul 1, 2026", size: "245 KB", status: "Ready" },
  { id: 2, name: "Purchase Agreement — Beachfront Villa", type: "Contract", date: "Jul 12, 2026", size: "1.2 MB", status: "Signed" },
  { id: 3, name: "Home Inspection Report — Downtown Loft", type: "Inspection", date: "Jul 11, 2026", size: "3.4 MB", status: "Received" },
  { id: 4, name: "Title Insurance Policy", type: "Insurance", date: "Jul 5, 2026", size: "890 KB", status: "Pending" },
  { id: 5, name: "Appraisal Report — Family Estate", type: "Appraisal", date: "Jul 8, 2026", size: "2.1 MB", status: "Received" },
  { id: 6, name: "HOA Documents — Suburban Estate", type: "HOA", date: "Jul 3, 2026", size: "560 KB", status: "Received" },
  { id: 7, name: "Closing Disclosure", type: "Financial", date: "Jul 14, 2026", size: "320 KB", status: "Pending" },
];
...
const TYPE_COLORS: Record<string, string> = {
  ...
  Appraisal: "bg-cyan-100 text-cyan-700",
...
export default function BuyerDocumentsPage() {
  ...
  useEffect(() => {
    async function fetchData() {
      try {
        const result = await apiGet<Document[]>("/buyer/documents");
        setDocuments(result);
      } catch {
  ...
  return (
    <BuyerLayout title="Documents" subtitle="Access all your transaction documents.">
                      ...
                      <tr key={doc.id} className="hover:bg-slate-50 transition">
                        ...
                        <td className="px-5 py-4">
                          <span className={`text-xs px-2.5 py-1 rounded-full font-medium ${
                            doc.status === "Ready" || doc.status === "Signed" ? "bg-green-100 text-green-700" :
