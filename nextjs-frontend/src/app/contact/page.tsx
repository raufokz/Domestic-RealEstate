...
const channels: Channel[] = [
  ...
  },
  {
    ...
    purpose: "Agent, brokerage, lender, and title partnerships and plans.",
    email: "partners@domesticrealestate.us",
    icon: "🤝",
  },
  {
    name: "Technical Support",
    purpose: "Help with tools, listings, imports, or anything not working.",
    email: "support@domesticrealestate.us",
    icon: "🛠️",
  },
  {
    name: "Privacy & Accessibility",
    purpose: "Data requests, privacy questions, and accessibility feedback.",
    email: "privacy@domesticrealestate.us",
    icon: "🔒",
  },
];
