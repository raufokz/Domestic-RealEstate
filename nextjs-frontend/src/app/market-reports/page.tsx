...
export const metadata: Metadata = {
  title: "Housing Market Reports & Economic Analytics | Domestic Real Estate",
  description:
    "Download quarterly housing market reports, median home price metrics, inventory forecasts, and cap rate indexes across major US metropolitan regions.",
  keywords: ["housing market report", "real estate analytics", "median home price trend", "real estate data report"],
  openGraph: {
    title: "Housing Market Reports | Domestic Real Estate",
    description: "Quarterly real estate data and economic forecasts.",
...
const reports = [
  { quarter: "Q2 2026", title: "National Housing Market & Interest Rate Report", pages: "28 Pages PDF", focus: "Price Stability & Mortgage Trends" },
  { quarter: "Q1 2026", title: "Sunbelt Regional Growth & Rental Yield Benchmark", pages: "32 Pages PDF", focus: "Multi-Family & Single-Family Rental Comps" },
];
      ...
      <section className="relative bg-[#0A2647] text-white py-24 sm:py-32 overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h1 className="font-heading text-4xl sm:text-6xl font-bold text-white max-w-4xl mx-auto leading-tight">
            Housing Market <span className="text-[#C9A227]">Reports & Data</span>
          </h1>
          <p className="mt-6 text-lg sm:text-xl text-slate-200 max-w-3xl mx-auto font-body leading-relaxed">
            In-depth economic research, median sales trends, and regional cap rate benchmarks compiled by data scientists.
          </p>
        </div>
      </section>
