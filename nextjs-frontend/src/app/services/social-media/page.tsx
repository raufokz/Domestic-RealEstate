...
const SERVICE_SLUG = "social-media";
const SERVICE_NAME = "Social Media Management";

const benefits = [
  {
    title: "Content Creation",
    description:
      "Scroll-stopping visuals and copy crafted by our creative team to resonate with your audience and amplify your brand voice.",
    icon: "M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z",
  },
  {
    title: "Community Management",
    description:
      "Active engagement with your followers — responding to comments, DMs, and building a loyal community around your brand.",
    icon: "M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z",
  },
  {
    title: "Analytics & Reporting",
    description:
      "Data-driven insights into your social performance with actionable recommendations for continuous improvement.",
    icon: "M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z",
  },
  {
    title: "Cross-Platform Posting",
    description:
      "Seamless content distribution across Instagram, Facebook, TikTok, LinkedIn, and Twitter with platform-specific optimization.",
...
const processSteps = [
  {
    ...
    title: "Strategy",
    description:
      "We define your brand voice, target audience, content pillars, and posting cadence for maximum impact.",
  },
  {
    step: 2,
    title: "Content",
    description:
      "Our creative team produces high-quality graphics, videos, and copy aligned with your strategy.",
  },
  {
    step: 3,
    title: "Posting",
    description:
      "Content is scheduled and published at optimal times with platform-specific formatting.",
  },
  {
    step: 4,
    title: "Analytics",
    description:
      "We track performance metrics, analyze trends, and refine strategy for continuous growth.",
  },
];
...
const faqs = [
  {
    ...
    answer:
      "We manage Instagram, Facebook, TikTok, LinkedIn, Twitter/X, YouTube, and Pinterest. We recommend platforms based on where your target audience is most active.",
  },
  {
    question: "How many posts do you create per week?",
    answer:
      "Our standard packages include 3–5 posts per week, depending on the platform and your goals. We focus on quality and consistency over quantity.",
  },
  {
    question: "Do you create the content or just post it?",
    answer:
      "We handle everything — from strategy and content creation to scheduling, posting, community management, and reporting. You approve content before it goes live.",
  },
  {
    question: "Can you work with our existing brand guidelines?",
    answer:
      "Absolutely. We adapt to your existing brand identity or help refine it. Our goal is to amplify your brand voice, not replace it.",
  },
];
      ...
      <section className="relative bg-gradient-to-br from-[#0A2647] via-[#0d3a6e] to-[#8B1E3F] text-white overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-6 py-24 md:py-32">
          ...
          <h1 className="text-4xl md:text-6xl font-bold leading-tight max-w-3xl">
            Grow Your Brand with <span className="text-[#C9A227]">Strategic Social Media</span>
          </h1>
          <p className="mt-6 text-lg md:text-xl text-gray-300 max-w-2xl">
            Transform your social presence into a powerful growth engine with content that connects and converts.
          </p>
          <a
            href="#quote"
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <p className="text-gray-600 text-center max-w-2xl mx-auto mb-16">
            We turn followers into fans and engagement into revenue.
          </p>
