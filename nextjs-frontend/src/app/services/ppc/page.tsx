...
const SERVICE_SLUG = "ppc";
const SERVICE_NAME = "PPC / Paid Ads Management";

const benefits = [
  {
    title: "Targeted Campaigns",
    description:
      "Reach your ideal customers with precision targeting based on demographics, interests, and search intent across all major platforms.",
    icon: "M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z",
  },
  {
    title: "A/B Testing",
    description:
      "Continuous split testing of ad copy, creative, and landing pages to maximize click-through and conversion rates.",
    icon: "M8 7h12m0 0l-4-4m4 4l-4 4m0 6H4m0 0l4 4m-4-4l4-4",
  },
  {
    title: "Real-Time Optimization",
    description:
      "AI-powered bid adjustments and budget allocation ensure your campaigns perform at their peak around the clock.",
    icon: "M13 10V3L4 14h7v7l9-11h-7z",
  },
  {
    title: "Transparent Reporting",
    description:
      "Clear, jargon-free reports showing exactly where your money goes and the ROI it generates for your business.",
...
const processSteps = [
  {
    ...
    title: "Research",
    description:
      "We dive deep into your market, competitors, and audience to build a data-backed campaign strategy.",
  },
  {
    step: 2,
    title: "Setup",
    description:
      "Campaign structures, ad creatives, landing pages, and tracking pixels are configured for optimal performance.",
  },
  {
    step: 3,
    title: "Launch",
    description:
      "We go live with carefully monitored campaigns, ensuring every element is functioning correctly.",
  },
  {
    step: 4,
    title: "Optimize",
    description:
      "Ongoing bid management, A/B testing, and budget reallocation to continuously improve ROI.",
  },
];
...
const faqs = [
  {
    ...
    answer:
      "We manage campaigns across Google Ads, Meta (Facebook & Instagram), TikTok Ads, LinkedIn Ads, and Microsoft Advertising. We recommend platforms based on where your audience is most active.",
  },
  {
    question: "How much should I spend on PPC advertising?",
    answer:
      "Ad spend depends on your industry, competition, and goals. We'll recommend a budget during our initial consultation and ensure every dollar is optimized for maximum return.",
  },
  {
    question: "How quickly will I see results from PPC?",
    answer:
      "Unlike SEO, PPC delivers immediate traffic. You'll typically see results within the first week, with optimization improvements continuing over the following months.",
  },
  {
    question: "Do you manage the ad spend directly?",
    answer:
      "We manage campaign strategy and optimization. Ad spend is billed directly from the platforms to your account, giving you full transparency and control over your budget.",
  },
];
      ...
      <section className="relative bg-gradient-to-br from-[#0A2647] via-[#0d3a6e] to-[#8B1E3F] text-white overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-6 py-24 md:py-32">
          ...
          <h1 className="text-4xl md:text-6xl font-bold leading-tight max-w-3xl">
            Maximize ROI with <span className="text-[#C9A227]">Data-Driven PPC Campaigns</span>
          </h1>
          <p className="mt-6 text-lg md:text-xl text-gray-300 max-w-2xl">
            Turn every advertising dollar into measurable growth with our expert paid media management.
          </p>
          <a
            href="#quote"
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <p className="text-gray-600 text-center max-w-2xl mx-auto mb-16">
            We engineer campaigns that consistently outperform industry benchmarks.
          </p>
