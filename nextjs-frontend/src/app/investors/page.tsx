...
export const metadata: Metadata = buildMetadata({
  ...
  description:
    "Scale your Domestic Real Estate Investment portfolio. Discover high-yielding Domestic Real Estate Assets, off-market deal flow, skip-tracing seller profiles, and managed Domestic Real Estate Holdings.",
  path: "/investors",
  keywords: [
...
export default function InvestorsPage() {
  const investorFeatures = [
    { title: "Domestic Real Estate Assets Acquisition", desc: "Direct phone, email, and property tax record profiles for acquiring high-yield domestic real estate assets nationwide." },
    ...
    { title: "Domestic Real Estate Holdings Strategy", desc: "Set target Cap Rates, minimum cash-on-cash yield, property type, and zip codes to grow your domestic real estate holdings." },
  ...
  return (
    <main className="min-h-screen bg-slate-50 text-[#0A2647]">
      <JsonLd data={[
        webPageLd({ name: "Domestic Real Estate Investment", description: "Off-market deal intelligence and asset management portal.", path: "/investors" }),
      ...
      <section className="relative bg-[#0A2647] text-white py-24 sm:py-32 overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h1 className="font-heading text-4xl sm:text-6xl font-bold text-white max-w-4xl mx-auto leading-tight">
            Institutional <span className="text-[#C9A227]">Domestic Real Estate Investment</span>
          </h1>
          <p className="mt-6 text-lg sm:text-xl text-slate-200 max-w-3xl mx-auto font-body leading-relaxed">
            Gain immediate access to verified off-market seller leads, high-yield Domestic Real Estate Assets, probate deals, and long-term Domestic Real Estate Holdings.
          </p>
