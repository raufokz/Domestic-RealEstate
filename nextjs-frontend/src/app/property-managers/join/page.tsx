...
export default function PropertyManagerJoinPage() {
  ...
  return (
    <main className="min-h-screen bg-white">
      <PageHero
        badge="Property Management Partnership"
        title="Join as a Property Manager"
        subtitle="Complete the application to partner with Domestic Real Estate."
      />
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-8 md:p-12">
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                <label className="block text-sm font-semibold text-[#0A2647] mb-2 font-heading">Portfolio Size</label>
                <select name="portfolio_size" value={formData.portfolio_size} onChange={handleChange} className="w-full px-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-[#C9A227] focus:border-transparent font-body">
              ...
              <div>
                <label className="block text-sm font-semibold text-[#0A2647] mb-2 font-heading">States Served</label>
              ...
              <div>
                ...
                <textarea name="message" value={formData.message} onChange={handleChange} rows={4} placeholder="Tell us about your management company and services..." className="w-full px-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-[#C9A227] focus:border-transparent font-body" />
              </div>
      ...
      <CTASection
        ...
        subtitle="Our partnerships team is here to help you get started."
