...
export default function SellerSettingsPage() {
  return (
    <SellerLayout title="Seller Settings" subtitle="Configure your account and notification preferences.">
      <div className="space-y-6 max-w-3xl">
        <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
          ...
          <div className="space-y-4">
            <div>
              ...
              <input type="text" defaultValue="Sarah Martinez" className="w-full border border-slate-200 rounded-lg px-3 py-2 text-sm text-[#0A2647] focus:outline-none focus:ring-2 focus:ring-[#C9A227]/30 focus:border-[#C9A227]" />
            </div>
            <div>
              <label className="block text-sm font-medium text-slate-600 mb-1">Email</label>
              <input type="email" defaultValue="sarah.martinez@email.com" className="w-full border border-slate-200 rounded-lg px-3 py-2 text-sm text-[#0A2647] focus:outline-none focus:ring-2 focus:ring-[#C9A227]/30 focus:border-[#C9A227]" />
            </div>
            <div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
          ...
          <div className="space-y-4">
            {[
              { label: "New inquiries", description: "When a buyer asks about your listing", enabled: true },
              { label: "Showing requests", description: "When a buyer requests a property showing", enabled: true },
              { label: "Offer notifications", description: "When you receive a new offer", enabled: true },
              { label: "Price alerts", description: "When comparable properties change price", enabled: false },
              { label: "Marketing updates", description: "Listing performance and engagement metrics", enabled: true },
            ].map((item) => (
