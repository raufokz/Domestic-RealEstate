...
export const CUSTOM_PLAN_SERVICES = [
  ...
  { id: "fb_marketplace", name: "Facebook Marketplace Listing & Management", priceEst: 100, category: "Core Services" },
  { id: "email_calendar", name: "Email & Calendar Management", priceEst: 150, category: "Core Services" },
  { id: "excel_sheets", name: "Excel / Google Sheets Data Management", priceEst: 100, category: "Core Services" },
  { id: "idx_web", name: "Custom IDX Agent Website", priceEst: 400, category: "Web & Tech" },
  { id: "website_updates", name: "Website Updates & Maintenance", priceEst: 150, category: "Web & Tech" },
